...
pedirJugada (i);
	...
	private boolean visualizarSalida(boolean acertada, int i, String newParam) {
		System.out.println ();
		if (acertada) {
	...
	private long modificarHeridos(int numRM, int numVM, int numAM, int numBM,
